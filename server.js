...
const categoryRules = [
  ...
  },
  {
    ...
    label: "AI & vibecode",
    color: "#db2777",
    keywords: ["ai", "a.i.", "llm", "gpt", "chatgpt", "chat gpt", "claude", "openai", "anthropic", "gemini", "deepseek", "grok", "llama", "mistral", "antigravity", "agentic", "ai agent", "ai agents", "prompt", "prompting", "prompt engineering", "ai model", "language model", "inference", "fine-tune", "training model", "neural", "transformer", "vibecode", "vibecoded", "vibecoder", "vibecoding", "vibecode'd", "vibe code", "vibe coding", "vibe coded", "vibe coder", "coded with ai", "built with ai", "ai coding", "ai app", "ai tool", "ai workflow", "ai automation", "ai assistant", "cursor ai", "cursor editor", "lovable", "bolt.new", "replit agent", "claude code", "codex", "squadcoding", "squad coding", "no-code", "nocode", "perplexity", "midjourney", "suno", "runway", "elevenlabs", "notion ai", "copilot", "windsurf", "v0.dev", "kiro", "vercel ai", "ai stack", "with claude", "using claude", "with lovable", "using lovable", "with kiro", "using kiro", "ai coding", "agentic coding", "claude built", "lovable built", "shipped with claude", "coded with ai", "built with claude", "built using claude", "built with lovable", "built using lovable", "built with kiro", "built using kiro", "shipped with lovable", "shipped with kiro", "coded with claude", "coded with lovable", "coded with kiro", "vibecoded with", ...aiVideoKeywords, ...screenRecordingKeywords],
    strongKeywords: ["ai", "claude", "gpt", "chatgpt", "chat gpt", "gemini", "openai", "anthropic", "deepseek", "grok", "llama", "mistral", "antigravity", "vibecode", "vibecoded", "vibecoder", "vibecoding", "vibecode'd", "vibe code", "vibe coding", "vibe coded", "vibe coder", "cursor ai", "cursor editor", "lovable", "bolt.new", "replit agent", "claude code", "squadcoding", "squad coding", "perplexity", "midjourney", "suno", "runway", "elevenlabs", "notion ai", "copilot", "windsurf", "v0.dev", "kiro", "vercel ai", "ai automation", "ai workflow", "ai stack", "with claude", "using claude", "with lovable", "using lovable", "with kiro", "using kiro", "ai coding", "agentic coding", "claude built", "lovable built", "shipped with claude", "coded with ai", "built with claude", "built using claude", "built with lovable", "built using lovable", "built with kiro", "built using kiro", "shipped with lovable", "shipped with kiro", "coded with claude", "coded with lovable", "coded with kiro", "vibecoded with"],
...
async function classifyTweets({ tweets, enabledCategoryIds, supabaseTweets = [], refresh = false }) {
  ...
  const classifiedAmbiguous = allAmbiguous.map((tweet) => {
    ...
    if (ai?.category && ai.category !== "skip") {
      ...
      const vibecodeKeywords = ["vibecode", "vibecoded", "vibecoder", "vibecoding", "vibecode'd", "vibe code", "vibe coding", "vibe coded", "vibe coder", "squadcoding", "squad coding", "coded with ai", "built with ai", "ai coding", "perplexity", "midjourney", "suno", "runway", "elevenlabs", "notion ai", "copilot", "windsurf", "v0.dev", "kiro", "vercel ai", "ai automation", "ai workflow", "ai stack", "with claude", "using claude", "with lovable", "using lovable", "with kiro", "using kiro", "ai coding", "agentic coding", "claude built", "lovable built", "shipped with claude", "coded with ai", "built with claude", "built using claude", "built with lovable", "built using lovable", "built with kiro", "built using kiro", "shipped with lovable", "shipped with kiro", "coded with claude", "coded with lovable", "coded with kiro", "vibecoded with"];
