...
const categoryRules = [
  {
    ...
    exclude: ["retweet", "clip from", "from tiktok", "from youtube", "from twitter", "credit to", "gif", "animated gif", "screen recording", "screen record", "recording screen", "gameplay", "screencast", "screen capture", "ui demo", ...internetClipKeywords],
  },
  {
    id: "ai_vibecode",
    label: "AI & vibecode",
    color: "#db2777",
    keywords: ["ai", "a.i.", "llm", "gpt", "chatgpt", "chat gpt", "claude", "openai", "anthropic", "gemini", "deepseek", "grok", "llama", "mistral", "antigravity", "agentic", "ai agent", "ai agents", "prompt", "prompting", "prompt engineering", "ai model", "language model", "inference", "fine-tune", "training model", "neural", "transformer", "vibecode", "vibecoded", "vibecoder", "vibecoding", "vibecode'd", "vibe code", "vibe coding", "vibe coded", "vibe coder", "coded with ai", "built with ai", "ai coding", "ai app", "ai tool", "ai workflow", "ai automation", "ai assistant", "cursor ai", "cursor editor", "lovable", "bolt.new", "replit agent", "claude code", "codex", "squadcoding", "squad coding", "no-code", "nocode", "perplexity", "midjourney", "suno", "runway", "elevenlabs", "notion ai", "copilot", "windsurf", "v0", "kiro", "vercel ai", "ai stack", "with claude", "using claude", "with lovable", "using lovable", "with kiro", "using kiro", "ai coding", "agentic coding", "claude built", "lovable built", "shipped with claude", "coded with ai", "built with claude", "built using claude", "built with lovable", "built using lovable", "built with kiro", "built using kiro", "shipped with lovable", "shipped with kiro", "coded with claude", "coded with lovable", "coded with kiro", "vibecoded with", ...aiVideoKeywords, ...screenRecordingKeywords],
    strongKeywords: ["ai", "claude", "gpt", "chatgpt", "chat gpt", "gemini", "openai", "anthropic", "deepseek", "grok", "llama", "mistral", "antigravity", "vibecode", "vibecoded", "vibecoder", "vibecoding", "vibecode'd", "vibe code", "vibe coding", "vibe coded", "vibe coder", "cursor ai", "cursor editor", "lovable", "bolt.new", "replit agent", "claude code", "squadcoding", "squad coding", "perplexity", "midjourney", "suno", "runway", "elevenlabs", "notion ai", "copilot", "windsurf", "v0", "kiro", "vercel ai", "ai automation", "ai workflow", "ai stack", "with claude", "using claude", "with lovable", "using lovable", "with kiro", "using kiro", "ai coding", "agentic coding", "claude built", "lovable built", "shipped with claude", "coded with ai", "built with claude", "built using claude", "built with lovable", "built using lovable", "built with kiro", "built using kiro", "shipped with lovable", "shipped with kiro", "coded with claude", "coded with lovable", "coded with kiro", "vibecoded with"],
  ...
  return categoryRules
    ...
    .map((category) => ({
      ...
      notes: category.id === "video"
        ? "Only choose video when hasVideo=true and hasGif=false. The video should be a creator-made production (e.g., vlogs, presenting, walkthroughs, tutorials, or original creative animations, cartoons, puppets like @just_t00ns, and AI-generated videos). Do NOT choose video for raw silent screen recordings, raw gameplay, raw charts, dashboard screenshots, or random reposted movie/show clips."
      ...
      messages: [
        {
          ...
          content: [
            ...
            "CRITICAL: Classify as video (video creation) when hasVideo=true and the video is a creator-made video production (including real presenters speaking, vlogs, explainer videos, walkthroughs, or self-made AI-generated videos, 2D/3D animations, cartoons, and puppet clips like @just_t00ns that represent their own creative content). Map their videoEvidence to 'creator_on_camera', 'self_made_production', or 'ai_generated_video'. Only exclude them if they are random reposted clips, internet clips, or generic memes.",
            "CRITICAL: If a video shows a screen recording, gameplay, chart, or slideshow, only classify it as video (video creation) if the tweet text indicates voiceover, walkthrough, tutorial, or presentation (e.g., mentions 'walkthrough', 'tutorial', 'quick guide', 'i made a vid', 'i filmed', 'recorded', 'show you how'). If it is a raw/silent screen recording, static chart, dashboard screenshot, or raw gameplay showing no explanation, map it to 'screen_recording' or 'not_video' and classify by topic (e.g. ai_vibecode, monad, crypto, nft_gamefi) or skip.",
            "CRITICAL: 'creator_on_camera' and 'person_speaking' are strictly reserved for humans, cartoon characters, puppets, or digital avatars appearing on screen. Map them to these categories if they represent the main presenter/character in the video.",
            ...
            "Skip or choose another category for random short clips, reposted clips, TikTok/YouTube/Twitter clips from other creators, movie/famous film/funny clips from the internet, memes, silent gameplay, raw screen recordings, browser/product screen captures, stock videos, compilations, and fan edits.",,
...
async function classifyTweets({ tweets, enabledCategoryIds, supabaseTweets = [], refresh = false }) {
  ...
  const classifiedAmbiguous = allAmbiguous.map((tweet) => {
    ...
    if (ai?.category && ai.category !== "skip") {
      ...
      const allowedVideoEvidence = new Set(["creator_on_camera", "person_speaking", "explainer_or_tutorial", "self_made_production", "ai_generated_video"]);
      const allowedWithoutKeywords = new Set(["creator_on_camera", "person_speaking", "self_made_production", "ai_generated_video"]);
      const isCreatorVideo = tweet.hasVideo &&
        ...
        (
          ...
          (hasStrongVideo && !["gif_or_image", "not_video"].includes(ai.videoEvidence))
        );
      ...
      const vibecodeKeywords = ["vibecode", "vibecoded", "vibecoder", "vibecoding", "vibecode'd", "vibe code", "vibe coding", "vibe coded", "vibe coder", "squadcoding", "squad coding", "coded with ai", "built with ai", "ai coding", "perplexity", "midjourney", "suno", "runway", "elevenlabs", "notion ai", "copilot", "windsurf", "v0", "kiro", "vercel ai", "ai automation", "ai workflow", "ai stack", "with claude", "using claude", "with lovable", "using lovable", "with kiro", "using kiro", "ai coding", "agentic coding", "claude built", "lovable built", "shipped with claude", "coded with ai", "built with claude", "built using claude", "built with lovable", "built using lovable", "built with kiro", "built using kiro", "shipped with lovable", "shipped with kiro", "coded with claude", "coded with lovable", "coded with kiro", "vibecoded with"];
