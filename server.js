...
const categoryRules = [
  ...
  },
  {
    ...
    strongKeywords: ["ai", "claude", "gpt", "vibecode", "vibecoded", "vibecoder", "vibecoding", "vibecode'd", "vibe code", "vibe coding", "vibe coded", "vibe coder", "cursor ai", "cursor editor", "lovable", "bolt.new", "replit agent", "claude code", "squadcoding", "squad coding"],
